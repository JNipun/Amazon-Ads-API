...
class AdvertisingApi:
    ...
    def list_campaigns(self):
        try:
            ...
            campaign_df.to_csv (file_path+'sponseredProducts_campaigns.csv',encoding="utf-8-sig",index=False)
            self.logger.info('sponseredProducts campaigns data have been fetched successfully')
            
        except Exception as e:
                self.logger.exception("Error in fetching of sponseredProducts campaigns data")
    ...
    def list_campaigns_ex(self):
        try:
            ...
            campaign_ex_df.to_csv (file_path+'sponseredProducts_campaigns_extended.csv',encoding="utf-8-sig",index=False)
            self.logger.info('sponseredProducts campaigns extended data have been fetched successfully')
            
        except Exception as e:
                self.logger.exception("Error in fetching of sponseredProducts campaigns extended data")
    ...
    def list_ad_groups(self):
        try:
            ...
            campaign_ad_grp_df.to_csv (file_path+'sponseredProducts_adGroups.csv',encoding="utf-8-sig",index=False)
            self.logger.info('sponseredProducts ad groups data have been fetched successfully')
            
        except Exception as e:
                self.logger.exception("Error in fetching of sponseredProducts adGroups data")
    ...
    def list_ad_groups_ex(self):
        try:
            ...
            campaign_ad_grp_ex_df.to_csv (file_path+'sponseredProducts_adGroups_extended.csv',encoding="utf-8-sig",index=False)
            self.logger.info('sponseredProducts adGroups extended data have been fetched successfully')
            
        except Exception as e:
                self.logger.exception("Error in fetching of sponseredProducts adGroups extended data")
    ...
    def list_product_ads(self):
        try:
            ...
            product_ads_df.to_csv (file_path+'sponseredProducts_productAds.csv',encoding="utf-8-sig",index=False)
            self.logger.info('sponseredProducts Product data have been fetched successfully')
        except Exception as e:
                self.logger.exception("Error in fetching of sponseredProducts products data")
    ...
    def list_product_ads_ex(self):
        try:
            ...
            product_ads_ex_df.to_csv (file_path+'sponseredProducts_productAds_extended.csv',encoding="utf-8-sig",index=False)

            self.logger.info('sponseredProducts Product extended data have been fetched successfully\n')
            self.logger.info('*************************\n')
        except Exception as e:
            self.logger.exception("Error in fetching of sponseredProducts products extended data \n")
